---
title: Writing signs
description: A sign is just-in-time guidance for an area of your codebase. It steers; it never blocks. You write signs in the signs section of signposts.yml.
order: 7
---

<p class="lede">A sign is just-in-time guidance for an area of your codebase. It steers; it never blocks. You write signs in the <code>signs:</code> section of <code>signposts.yml</code>.</p>
